# RealTimeTranscription Android Java - Student
## 1. Introduction
This repository is part of the Speech to Text/Text to Speech labs.
...
This is the student version of the project RealTimeTranscription
Android Java. It contains incomplete code that requires to follow
lab instructions in order to run.
